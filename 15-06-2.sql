...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-06-2023 a las 23:01:19
...
(154, 'IMT_CP_M2004_T1_1.pdf', '2023-06-13', '/public/uploads/220785f0e2b5531ae0772efd91034c25IMT_CP_M2004_T1_1.pdf', 0),
(155, 'PDF-BOLETAEB01-1620606031417.pdf', '2023-06-13', '/public/uploads/220785f0e2b5531ae0772efd91034c25PDF-BOLETAEB01-1620606031417.pdf', 0),
(156, 'ASESORIAS STEAM G03.docx.pdf', '2023-06-14', '/public/uploads/a1036bf988fdcdad6aea5025ec95cc92ASESORIAS STEAM G03.docx.pdf', 0),
(157, '-.pdf', '2023-06-14', '/public/uploads/a1036bf988fdcdad6aea5025ec95cc92-.pdf', 0),
(158, 'PDF-BOLETAEB01-1620606031417 (1).pdf', '2023-06-15', '/public/uploads/e876e374c427e49d80e8b5b72e1ce728PDF-BOLETAEB01-1620606031417 (1).pdf', 0);
...
INSERT INTO `empresa` (`id_empresa`, `RUC`, `Razon_socal_empresa`, `Referencia_ubicacion_empresa`, `mapa_ubicacion_empresa`, `id_distrito`) VALUES
(1, 7, 'Name', 'Name', NULL, 0),
(2, 7, 'Name', 'Name', NULL, 0),
(3, 7, 'Name', 'Name', NULL, 0),
(4, 7, 'Name', 'Name', NULL, 0),
(5, 7, 'Name', 'Name', NULL, 0),
(6, 7, 'Name', 'Name', NULL, 0),
(7, 7, 'Name', 'Name', NULL, 0),
(8, 7, 'Name', 'Name', NULL, 0),
(9, 99999, 'Pepito Construccione', 'Urb San Angela', NULL, 1),
(10, 99999, '1', '1', NULL, 1);
...
CREATE TABLE `empresa_alumno` (
  ...
  `carta_presentacion` int(11) DEFAULT NULL,
  `carta_aceptacion` int(11) DEFAULT NULL,
  `fecha_inicio` date DEFAULT NULL,
  `fecha_fin` date DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `empresa_alumno`
--

INSERT INTO `empresa_alumno` (`id_empresa_alumno`, `id_alumno`, `id_empresa`, `id_representante`, `id_jefe_inmediato`, `carta_presentacion`, `carta_aceptacion`, `fecha_inicio`, `fecha_fin`) VALUES
(1, '332172003', 1, 1, NULL, 0, 0, NULL, NULL),
(2, '332172003', 2, 2, NULL, 0, 0, NULL, NULL),
(3, '332172003', 3, 3, NULL, 0, 0, NULL, NULL),
(4, '332172003', 4, 4, NULL, 0, 0, NULL, NULL),
(5, '332172003', 5, 5, NULL, 0, 0, NULL, NULL),
(6, '332172003', 6, 6, NULL, 0, 0, NULL, NULL),
(7, '332172003', 7, 7, 12, 0, 158, '2023-06-20', '2023-06-12'),
(8, '332131002', 8, 8, NULL, NULL, NULL, NULL, NULL),
(9, '332131002', 9, 9, NULL, NULL, NULL, NULL, NULL),
(10, '332131002', 10, 10, NULL, NULL, NULL, NULL, NULL);
...
--
-- Estructura de tabla para la tabla `empresa_encargados`
--

CREATE TABLE `empresa_encargados` (
  `id_empresa_encargado` int(11) NOT NULL,
  `id_empresa` int(11) DEFAULT NULL,
  ...
  `numero` varchar(59) DEFAULT NULL,
...
--
-- Volcado de datos para la tabla `empresa_encargados`
--

INSERT INTO `empresa_encargados` (`id_empresa_encargado`, `id_empresa`, `id_puesto`, `nombre`, `apellido_p`, `apellido_m`, `cargo`, `correo`, `numero`, `Genero`, `GradoInstruccion`, `DNI`) VALUES
(1, 1, 1, 'Name', 'Name', 'Name', 'Name', '', NULL, 'Choose...', 'Choose...', ''),
(2, 2, 1, 'Name', 'Name', 'Name', 'Name', '', NULL, 'Choose...', 'Choose...', ''),
(3, 3, 1, 'Name', 'Name', 'Name', 'Name', '', NULL, 'Choose...', 'Choose...', ''),
(4, 4, 1, 'Name', 'Name', 'Name', 'Name', '', NULL, 'Choose...', 'Choose...', ''),
(5, 5, 1, 'Name', 'Name', 'Name', 'Name', '', NULL, 'Choose...', 'Choose...', ''),
(6, 6, 1, 'Name', 'Name', 'Name', 'Name', '', NULL, 'Choose...', 'Choose...', ''),
(7, 7, 1, 'Name', 'Name', 'Name', 'Name', '', NULL, 'Choose...', 'Choose...', ''),
(8, 8, 1, 'Name', 'Name', 'Name', 'Name', '', NULL, 'Choose...', 'Choose...', ''),
(9, 9, 1, 'Tutos', 'Pro', 'YT', 'Gerente Nacional', '', NULL, 'Masculino', 'Grado medio', ''),
(10, 10, 1, '', '', '', '1', '', NULL, 'Femenino', 'Choose...', ''),
(11, 0, 2, '', '', '', '', '', '', '', '', ''),
(12, 7, 2, '12', '12', '12', '12', '12', '12', 'Masculino', 'Educación básica esp', '12');
...
(2, '332131002', 156, 157, NULL, 1, 'Creado', '2023-06-14');
...
INSERT INTO `persona` (`id_persona`, `nombre`, `apellido_paterno`, `apellido_materno`, `DNI`, `direccion`, `correo`, `celular`, `departamento`, `provincia`, `distrito`) VALUES
(1, 'Juan', 'Pérez', 'González', '74085467', 'Urb San Angela', '@hotmai.com', '1', 1, 0, 0),
(2, 'María', 'García', 'Hernández', '', NULL, NULL, NULL, NULL, NULL, NULL),
(3, 'Pedro', 'Martínez', 'Sánchez', '', NULL, NULL, NULL, NULL, NULL, NULL),
(4, 'Ana', 'López', 'Rodríguez', '', NULL, NULL, NULL, NULL, NULL, NULL),
(5, 'Carlos', 'Fernández', 'Gómez', '', NULL, NULL, NULL, NULL, NULL, NULL),
(6, 'Sofía', 'Díaz', 'Gutiérrez', '', NULL, NULL, NULL, NULL, NULL, NULL),
(7, 'Jorge', 'González', 'García', '', NULL, NULL, NULL, NULL, NULL, NULL),
(8, 'Laura', 'Jiménez', 'Pérez', '', NULL, NULL, NULL, NULL, NULL, NULL),
(9, 'David', 'Gómez', 'Herrera', '', NULL, NULL, NULL, NULL, NULL, NULL),
(10, 'Isabel', 'Álvarez', 'Torres', '', 'Urb San Angela', '@hotmai.com', '123123', 1, 0, 0),
(11, 'Miguel', 'Ruiz', 'Fernández', '', NULL, NULL, NULL, NULL, NULL, NULL),
(12, 'Lucía', 'Hernández', 'Moreno', '', NULL, NULL, NULL, NULL, NULL, NULL),
(13, 'José', 'García', 'Martínez', '', NULL, NULL, NULL, NULL, NULL, NULL),
(14, 'Paula', 'Sánchez', 'Jiménez', '', NULL, NULL, NULL, NULL, NULL, NULL),
(15, 'Mario', 'Gutiérrez', 'González', '', NULL, NULL, NULL, NULL, NULL, NULL),
(16, 'Silvia', 'Fernández', 'López', '', NULL, NULL, NULL, NULL, NULL, NULL),
(17, 'Roberto', 'Pérez', 'García', '', NULL, NULL, NULL, NULL, NULL, NULL),
(18, 'Esther', 'Rodríguez', 'Hernández', '', NULL, NULL, NULL, NULL, NULL, NULL),
(19, 'Luis', 'Martínez', 'Sánchez', '', NULL, NULL, NULL, NULL, NULL, NULL),
(20, 'Carmen', 'González', 'Fernández', '', NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `puesto` (`id_puesto`, `nombre`, `id_role`) VALUES
(1, 'Representa', 4),
(2, 'Datos jefe', 4);
...
--
-- Estructura de tabla para la tabla `tdocumento_empresa`
--

CREATE TABLE `tdocumento_empresa` (
  `id` int(11) NOT NULL,
  `nombre` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `tdocumento_empresa`
--

INSERT INTO `tdocumento_empresa` (`id`, `nombre`) VALUES
(1, 'Plan Actividades'),
(2, 'Control Mensual');
...
--
-- Indices de la tabla `empresa_encargados`
--
ALTER TABLE `empresa_encargados`
  ADD PRIMARY KEY (`id_empresa_encargado`);
...
--
-- Indices de la tabla `tdocumento_empresa`
--
ALTER TABLE `tdocumento_empresa`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `documento`
  MODIFY `id_documento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=159;
...
--
ALTER TABLE `empresa_alumno`
  MODIFY `id_empresa_alumno` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT de la tabla `empresa_encargados`
--
ALTER TABLE `empresa_encargados`
  MODIFY `id_empresa_encargado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
-- AUTO_INCREMENT de la tabla `tdocumento_empresa`
--
ALTER TABLE `tdocumento_empresa`
