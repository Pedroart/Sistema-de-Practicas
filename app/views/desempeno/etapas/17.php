...
la fecha de inicio y culminación de sus labores. Debe escanear y subir este documento al sistema en formato
POF,
    </p>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form name="formFichaDatos" id="formFichaDatos">
                        ...
                        <div class="form-group row">
                            <label for="Plan_Actividades" class="col-sm-4 col-form-label">Contrato</label>
                            <div class="col-sm-8">
