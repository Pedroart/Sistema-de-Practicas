<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            {{ Form::label('name') }}
            {{ Form::text('name', $empleado->name, ['class' => 'form-control' . ($errors->has('name') ? ' is-invalid' : ''), 'placeholder' => 'Name']) }}
        ...
        <div class="form-group">
            {{ Form::label('grado_instruccion') }}
            {{ Form::text('grado_instruccion', $empleado->grado_instruccion, ['class' => 'form-control' . ($errors->has('grado_instruccion') ? ' is-invalid' : ''), 'placeholder' => 'Grado Instruccion']) }}
            {!! $errors->first('grado_instruccion', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('cargo') }}
