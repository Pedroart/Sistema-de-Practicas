<div class="box box-info padding-1">
    <div class="box-body">
        <div class="form-group">
            ...
            {{ Form::select('estudiante_id', [] , $proceso->estudiante_id, ['class' => 'form-control' . ($errors->has('estudiante_id') ? ' is-invalid' : ''), 'placeholder' => 'Estudiante Id']) }}
            {!! $errors->first('estudiante_id', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('semestre_id') }}
            {{ Form::select('semestre_id', $semestre, $proceso->semestre_id, ['class' => 'form-control' . ($errors->has('semestre_id') ? ' is-invalid' : ''), 'placeholder' => 'Semestre Id']) }}
        ...
        <div class="form-group">
            ...
            {{ Form::select('tipoproceso_id', $tipoprocesos , $proceso->tipoproceso_id, ['class' => 'form-control' . ($errors->has('tipoproceso_id') ? ' is-invalid' : ''), 'placeholder' => 'Tipoproceso Id']) }}
