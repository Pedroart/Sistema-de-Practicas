                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('procesos.destroy',$proceso->id) }}" method="POST">
                                        @if(isset($proceso->procesos->id))
                                            <a class="btn btn-sm btn-primary" href="{{ route('datos.view', $proceso->procesos->id) }}">
                                                <i class="fa fa-fw fa-eye"></i> {{ __('Datos Estudiante') }}
                                            </a>
                                        @else
                                        ...
                                        <a class="btn btn-sm btn-primary " href="{{ route('validacion.view',$proceso->id) }}"><i class="fa fa-fw fa-eye"></i> {{ __('Mostrar') }}</a>
